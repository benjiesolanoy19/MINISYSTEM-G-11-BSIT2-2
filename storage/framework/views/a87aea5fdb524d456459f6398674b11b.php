...
<div class="container-fluid" x-data="borrowingsList()">
  <div class="page-header" data-aos="fade-down" data-aos-duration="600">
    ...
    <div data-aos="fade-left" data-aos-delay="200">
      <a href="<?php echo e(route('borrowings.create')); ?>" class="btn btn-primary btn-lg rounded-pill px-4">
  ...
  <div class="filter-tabs" data-aos="fade-up" data-aos-delay="300">
    <a href="#" class="filter-tab active" onclick="filterBorrowings('all')">
      <i class="fas fa-list me-1"></i>All (<?php echo e($borrowings->count()); ?>)
    </a>
    <a href="#" class="filter-tab" onclick="filterBorrowings('pending')">
      <i class="fas fa-clock me-1"></i>Pending (<?php echo e($borrowings->where('status', 'pending')->count()); ?>)
    </a>
    <a href="#" class="filter-tab" onclick="filterBorrowings('approved')">
      <i class="fas fa-check me-1"></i>Approved (<?php echo e($borrowings->where('status', 'approved')->count()); ?>)
    </a>
    <a href="#" class="filter-tab" onclick="filterBorrowings('returned')">
      <i class="fas fa-undo me-1"></i>Returned (<?php echo e($borrowings->where('status', 'returned')->count()); ?>)
    </a>
  </div>
  ...
  <?php if($borrowings->count() > 0): ?>
    <div class="borrowing-cards-grid" data-aos="fade-up" data-aos-delay="400">
      ...
      <div class="borrowing-card" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->index * 50); ?>">
        <div class="borrowing-card-header">
          <div class="equipment-icon">
            <i class="fas fa-laptop"></i>
          </div>
          <span class="status-badge status-<?php echo e($borrowing->status); ?>">
            <i class="fas fa-<?php echo e($borrowing->status === 'pending' ? 'clock' : ($borrowing->status === 'approved' ? 'check' : ($borrowing->status === 'returned' ? 'undo' : 'exclamation'))); ?>"></i>
        ...
        <div class="borrowing-card-body">
          <h3 class="equipment-name"><?php echo e($borrowing->equipment->name ?? 'N/A'); ?></h3>

          <?php if($borrowing->equipment->category): ?>
          <span class="equipment-category category-<?php echo e(strtolower($borrowing->equipment->category)); ?>">
            <?php echo e($borrowing->equipment->category); ?>
          ...
          <div class="borrowing-details">
            <div class="detail-item">
              ...
              <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($borrowing->borrow_date)->format('M d, Y')); ?></span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Return Date</span>
              <span class="detail-value">
                <?php if($borrowing->return_date): ?>
                  <?php echo e(\Carbon\Carbon::parse($borrowing->return_date)->format('M d, Y')); ?>
            ...
            <div class="detail-item" style="grid-column: span 2;">
              ...
              <span class="detail-value"><?php echo e(Str::limit($borrowing->purpose, 60)); ?></span>
            </div>
            <?php endif; ?>
          </div>
          ...
          <div class="card-actions">
            ...
            <form method="POST" action="<?php echo e(route('borrowings.return', $borrowing)); ?>" style="display: inline;">
              <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('equipment.index')); ?>" class="btn-card btn-outline-secondary">
  ...
  <?php else: ?>
    <div class="empty-state" data-aos="fade-in" data-aos-delay="400">
      ...
      <a href="<?php echo e(route('borrowings.create')); ?>" class="btn btn-primary rounded-pill px-4 py-2">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CLMFS_GROUP11 - Copy - Copy - Copy\resources\views/borrowings/list.blade.php ENDPATH**/ ?>