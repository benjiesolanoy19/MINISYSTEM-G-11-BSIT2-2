...
<body>
    ...
    <?php if(auth()->check() && !request()->is('login') && !request()->is('register') && !request()->is('password/*')): ?>
...
<?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/layouts/app.blade.php ENDPATH**/ ?>