                ...
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-lg-5 text-lg-end">
                        <div class="d-flex justify-content-lg-end gap-2 flex-wrap">
                            <a href="<?php echo e(route('borrowings.index')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/borrowings/cards.blade.php ENDPATH**/ ?>