...
<title><?php echo $__env->yieldContent('title', 'Computer Laboratory Facilities Management System (CLFMS)'); ?></title>
                ...
                <div class="dropdown-menu dropdown-menu-end notifications shadow-lg border-0 mt-3" aria-labelledby="notificationDropdown">
                    ...
                    <div class="notification-list">
                        <?php $__empty_1 = true; $__currentLoopData = $globalNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="notification-item <?php echo e($notification->is_read ? '' : 'unread'); ?> hover-lift" onclick="markAsRead(<?php echo e($notification->id); ?>, '<?php echo e($notification->action_url ?? ''); ?>')" style="cursor: pointer;" data-notification-id="<?php echo e($notification->id); ?>">
                                <div class="d-flex align-items-start gap-3">
                                    <div class="notification-icon">
                                        <i class="fas <?php echo e($notification->icon_class ?? 'fa-info-circle'); ?> text-<?php echo e($notification->color_class ?? 'primary'); ?>"></i>
                                    </div>
                                    <div class="notification-content w-100">
                                        <div class="d-flex justify-content-between align-items-start gap-2 mb-2 flex-wrap">
                                            <h6 class="notification-title mb-0 fw-semibold text-dark">
                                                <?php echo e(\Illuminate\Support\Str::limit($notification->title ?? 'Notification', 45)); ?>

                                            </h6>
                                            <small class="notification-time text-muted"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                        </div>
                                        <p class="notification-message text-muted mb-2">
                                            <?php echo e(\Illuminate\Support\Str::limit($notification->message ?? 'No details available.', 100)); ?>
                    ...
                    <div class="notification-footer p-3 border-top bg-light">
                        <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap">
                            <a href="<?php echo e(route('notifications.index')); ?>" class="btn btn-primary btn-sm rounded-pill px-3 py-2">
                                <i class="fas fa-eye me-1"></i>View All
                            </a>
                            <small class="text-muted d-flex align-items-center gap-1 mb-0">
                                <i class="fas fa-clock"></i><?php echo e(now()->format('g:i A')); ?>
            ...
            <div class="dropdown">
                <button class="btn btn-sm p-0 d-flex align-items-center dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="user-avatar me-2">
                        <?php if(Auth::user()->profile_picture_url): ?>
                            <img src="<?php echo e(Auth::user()->profile_picture_url); ?>" alt="<?php echo e(Auth::user()->name); ?>" />
                        <?php else: ?>
                            <span class="text-primary fw-bold" style="font-size:1rem;"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                        <?php endif; ?>
                        <span class="user-status-dot"></span>
                    </div>
                    <div class="d-none d-md-flex flex-column text-start">
                        <span class="fw-semibold" style="font-size:0.95rem;"><?php echo e(Auth::user()->name); ?></span>
                        <small class="text-muted" style="font-size:0.79rem;"><?php echo e(ucfirst(Auth::user()->role)); ?></small>
                    </div>
                </button>
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 profile-dropdown-menu mt-3">
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('profile.index')); ?>"><i class="fas fa-user me-2"></i>View Profile</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('profile.index')); ?>"><i class="fas fa-edit me-2"></i>Edit Profile</a></li>
...
<script>
    ...
    function updateNotificationBadge() {
        fetch('<?php echo e(route("api.notifications.unreadCount")); ?>')
            .then(res => res.json())
            .then(data => {
...
<?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>