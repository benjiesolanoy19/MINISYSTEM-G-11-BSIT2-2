    ...
    <div class="col-md-3 mb-3" data-aos="fade-up" data-aos-delay="150">
      <div class="card stat-card text-center">
        <div class="card-body">
          ...
          <div class="stat-value"><?php echo e($stats['total_equipment'] ?? 0); ?></div>
    ...
    <div class="col-md-3 mb-3" data-aos="fade-up" data-aos-delay="200">
      <div class="card stat-card text-center">
        <div class="card-body">
          ...
          <div class="stat-value"><?php echo e($stats['total_reservations'] ?? 0); ?></div>
    ...
    <div class="col-md-3 mb-3" data-aos="fade-up" data-aos-delay="250">
      <div class="card stat-card text-center">
        <div class="card-body">
          ...
          <div class="stat-value"><?php echo e($stats['active_incidents'] ?? 0); ?></div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr data-aos="fade-in" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <td><?php echo e($reservation->user->name ?? 'N/A'); ?></td>
                    <td><?php echo e($reservation->laboratory->name ?? 'N/A'); ?></td>
                    <td>
                      ...
                      <?php else: ?>
                        <span class="badge" style="background: #94a3b8; color: white;"><i class="fas fa-info-circle"></i> <?php echo e(ucfirst($reservation->status)); ?></span>
                      <?php endif; ?>
                    </td>
                  </tr>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr data-aos="fade-in" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <td><?php echo e(ucfirst($incident->type ?? 'Unknown')); ?></td>
                    <td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CLMFS_GROUP11 - Copy - Copy - Copy\resources\views/admin/index.blade.php ENDPATH**/ ?>