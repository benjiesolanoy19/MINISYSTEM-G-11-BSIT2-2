...
<div class="container-fluid">
  ...
  <?php if(isset($myReports) && $myReports->count()): ?>
    <div class="card mt-4 p-3">
      <h5 class="mb-3">My Reports</h5>
      <div class="list-group">
        <?php $__currentLoopData = $myReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e(route('bug-reports.show', $r)); ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
              <strong>#<?php echo e($r->id); ?></strong> <?php echo e(Str::limit($r->title, 60)); ?>

              <div class="small text-muted"><?php echo e(ucfirst($r->priority)); ?> • <?php echo e(str_replace('_', ' ', ucfirst($r->status))); ?></div>
            </div>
            <div class="text-muted small"><?php echo e($r->created_at->diffForHumans()); ?></div>
          </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/bug_reports/create.blade.php ENDPATH**/ ?>