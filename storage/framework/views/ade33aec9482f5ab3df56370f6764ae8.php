...
<div class="container-fluid borrow-page" x-data="borrowingForm()" x-init="initializeSelection()">
  <div class="page-header" data-aos="fade-down" data-aos-duration="600">
    ...
    <a href="<?php echo e(route('borrowings.index')); ?>" class="btn btn-outline-primary btn-lg rounded-pill px-4" data-aos="fade-left" data-aos-delay="150">
  ...
  <?php else: ?>
    <form method="POST" action="<?php echo e(route('borrowings.store')); ?>" id="borrowingForm">
      <?php echo csrf_field(); ?>
...
function borrowingForm() {
  return {
    equipmentData: <?php echo json_encode($equipment->map->only(['id','name','image','category','available_quantity','description'])->all()); ?>,
    categories: <?php echo json_encode(array_merge(['All'], $equipment->pluck('category')->unique()->sort()->values()->all())); ?>,
    selectedId: null,
    selectedName: '',
    selectedImage: '',
    selectedCategory: '',
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CLMFS_GROUP11 - Copy - Copy - Copy\resources\views/borrowings/create.blade.php ENDPATH**/ ?>