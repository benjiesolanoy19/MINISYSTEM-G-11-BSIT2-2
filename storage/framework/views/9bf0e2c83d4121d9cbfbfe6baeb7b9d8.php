...
<div class="container-fluid">
  ...
  <div class="card" data-aos="fade-up" data-aos-duration="700">
    ...
    <div class="card-body p-4">
      <form method="POST" action="<?php echo e(route('equipment.store')); ?>" enctype="multipart/form-data" x-data="equipmentForm()" @submit="loading = true">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/equipment/create.blade.php ENDPATH**/ ?>