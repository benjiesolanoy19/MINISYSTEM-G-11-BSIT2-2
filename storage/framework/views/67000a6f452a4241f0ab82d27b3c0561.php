...
<li class="sidebar-item">
            <a href="<?php echo e(route('dashboard')); ?>" title="Home" class="sidebar-link <?php echo e(Request::is('dashboard') ? 'active' : ''); ?>">
        ...
        <?php if($role === 'student'): ?>
            <li class="sidebar-item">
                <a href="<?php echo e(route('logs.index')); ?>" title="Time In / Out" class="sidebar-link <?php echo e(Request::is('logs') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('borrowings.create')); ?>" title="Borrow Equipment" class="sidebar-link <?php echo e(Request::is('borrowings/create') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('borrowings.index')); ?>" title="My Requests" class="sidebar-link <?php echo e(Request::is('borrowings') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('borrowings.return-equipment')); ?>" title="Return Equipment" class="sidebar-link <?php echo e(Request::is('borrowings/return-equipment') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('incidents.index')); ?>" title="My Reports" class="sidebar-link <?php echo e(Request::is('incidents*') ? 'active' : ''); ?>">
        ...
        <li class="sidebar-item">
            <a href="<?php echo e(route('notifications.index')); ?>" title="Notifications" class="sidebar-link <?php echo e(Request::is('notifications*') ? 'active' : ''); ?>">
        ...
        <?php if(Auth::user()->role === 'admin' || Auth::user()->role === 'staff'): ?>
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('staff.pending-requests')); ?>" title="Borrow Requests" class="sidebar-link <?php echo e(Request::is('borrowings/staff/pending-requests') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('staff.return-management')); ?>" title="Return Management" class="sidebar-link <?php echo e(Request::is('borrowings/staff/return-management') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('equipment.index')); ?>" title="Equipment Inventory" class="sidebar-link <?php echo e(Request::is('equipment*') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('equipment.create')); ?>" title="Add Equipment" class="sidebar-link <?php echo e(Request::is('equipment/create') ? 'active' : ''); ?>">
                    <i class="fas fa-plus-circle"></i>
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('logs.index')); ?>" title="Time Logs" class="sidebar-link <?php echo e(Request::is('logs') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-item">
                ...
                <a href="<?php echo e(route('reports.usage')); ?>" title="Reports" class="sidebar-link <?php echo e(Request::is('reports*') ? 'active' : ''); ?>">
        ...
        <?php if(Auth::user()->role === 'admin'): ?>
            ...
            <li class="sidebar-item">
                <a href="<?php echo e(route('admin.index')); ?>" title="Admin Panel" class="sidebar-link <?php echo e(Request::is('admin*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <ul class="sidebar-menu footer-menu mb-0">
            <li class="sidebar-item">
                <a href="<?php echo e(route('profile.index')); ?>" title="My Profile" class="sidebar-link <?php echo e(Request::is('profile*') ? 'active' : ''); ?>">
                    <i class="fas fa-user"></i>
                    <span>My Profile</span>
                </a>
            </li>
            <li class="sidebar-item">
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-100 mb-0">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>