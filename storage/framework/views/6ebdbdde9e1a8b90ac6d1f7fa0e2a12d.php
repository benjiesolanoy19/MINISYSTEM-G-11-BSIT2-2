                            ...
                            <div class="col-12">
                                <div class="req-row d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-3">
                                    <div class="d-flex align-items-center gap-3" style="min-width: 280px;">
                                        <img class="img-eq" src="<?php echo e(optional($r->equipment)->image_url ?? ($r->equipment ? $r->equipment->getImageUrl() : 'https://via.placeholder.com/128?text=EQ')); ?>" alt="Equipment">
                                        <div>
                                            <div class="fw-bold"><?php echo e(optional($r->student)->name ?? 'Unknown student'); ?></div>
                                            <div class="text-muted small">Equipment: <strong class="text-dark"><?php echo e(optional($r->equipment)->name ?? 'Unknown equipment'); ?></strong></div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/staff/pending-requests.blade.php ENDPATH**/ ?>