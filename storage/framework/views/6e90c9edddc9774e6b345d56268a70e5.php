          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                ...
                <td><strong><?php echo e(\Carbon\Carbon::parse($log->timestamp)->format('M d, Y')); ?></strong><br><small class="text-muted"><?php echo e(\Carbon\Carbon::parse($log->timestamp)->format('h:i A')); ?></small></td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\CLMFS_GROUP11 - Copy - Copy\resources\views/logs/list.blade.php ENDPATH**/ ?>