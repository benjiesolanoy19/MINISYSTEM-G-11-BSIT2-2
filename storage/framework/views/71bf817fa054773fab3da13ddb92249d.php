...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group staff-secret" data-aos="fade-up" data-aos-delay="280" style="display: none;">
                        <label for="register-secret_code">
                            <i class="fas fa-key"></i> Staff Secret Code
                        </label>
                        <input
                            id="register-secret_code"
                            type="password"
                            name="secret_code"
                            class="form-control"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const staffSecretGroup = document.querySelector('.staff-secret');

            const toggleSecret = () => {
                if (!staffSecretGroup || !roleSelect) return;
                staffSecretGroup.style.display = roleSelect.value === 'staff' ? 'block' : 'none';
            };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/auth/register.blade.php ENDPATH**/ ?>