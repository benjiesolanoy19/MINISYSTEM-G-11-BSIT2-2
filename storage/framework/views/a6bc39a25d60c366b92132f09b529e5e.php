            ...
            <div class="col-lg-7">
                <div class="hero-content text-center text-lg-start">
                    ...
                    <div class="hero-buttons justify-content-center justify-content-lg-start">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-lg">Login</a>
                    </div>
                </div>
            </div>
...
<section class="feature-section bg-white" id="contact">
    <div class="container-lg text-center" data-aos="fade-up" data-aos-duration="700">
        ...
        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg me-3">Sign Up Now</a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-lg">Login</a>
    </div>
</section>
...
<footer class="footer">
    <div class="container-lg text-center">
        <p class="mb-2">&copy; <?php echo e(date('Y')); ?> ICTFE. All rights reserved.</p>
...
<?php /**PATH C:\xampp\htdocs\CLMFS_GROUP11 - Copy - Copy - Copy\resources\views/welcome.blade.php ENDPATH**/ ?>