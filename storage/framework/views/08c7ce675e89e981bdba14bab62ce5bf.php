...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ICTFE Dashboard'); ?></title>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 mt-3">
                    ...
                    <li>
                        <a class="dropdown-item py-2" href="<?php echo e(route('login')); ?>">
                            <i class="fas fa-right-to-bracket me-2"></i>Login
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item py-2" href="<?php echo e(route('register')); ?>">
