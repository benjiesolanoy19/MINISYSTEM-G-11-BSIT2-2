...
<?php $__env->startSection('title', 'Admin Dashboard - ICTFE'); ?>
    ...
    <div class="container-fluid py-5">
        ...
        <div class="admin-stats">
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?php echo e($studentCount); ?></div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?php echo e($staffCount); ?></div>
            </div>
        ...
        <div class="admin-content">
            ...
            <div class="admin-card">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="btn-admin-nav">
            ...
            <div class="admin-card">
                ...
                <a href="<?php echo e(route('admin.equipment')); ?>" class="btn-admin-nav">
            ...
            <div class="admin-card">
                ...
                <a href="<?php echo e(route('admin.logs')); ?>" class="btn-admin-nav">
            ...
            <div class="admin-card" style="margin-top: 20px;">
                ...
                <div>
                    <?php $__currentLoopData = $recentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="log-item">
                            <span class="log-timestamp"><?php echo e($log->created_at->format('M d, H:i')); ?></span>
                            <span class="log-action"><?php echo e($log->action ?? 'System Activity'); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MINISYSTEM-G-11-BSIT2-2\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>