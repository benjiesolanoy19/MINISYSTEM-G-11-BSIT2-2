...
@section('title', 'Reset Password - CLFMS')
...
.reset-header { text-align: center; margin-bottom: 35px; }
...
.reset-header h2 { font-size: 28px; font-weight: 700; color: #1f2937; margin-bottom: 8px; }
.reset-header p { color: #6b7280; font-size: 14px; }
...
<div class="reset-container">
  <div class="reset-card">
    ...
    <form method="POST" action="{{ route('password.update') }}">
      ...
      <button type="submit" class="btn-submit"><i class="fas fa-save me-2"></i>Reset Password</button>
    </form>
