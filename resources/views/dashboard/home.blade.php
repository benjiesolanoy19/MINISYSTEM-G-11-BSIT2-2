            ...
            <div class="card-modern dashboard-hero hover-lift">
                <div class="d-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center gap-4">
                    <div>
                        ...
                        <h1 id="dashboardGreeting" class="hero-title mt-3 mb-2">Welcome back, {{ $user->name }}.</h1>
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            <span class="hero-meta-pill"><i class="fas fa-calendar-day"></i><span id="dashboardLocalDate">{{ now()->format('F j, Y') }}</span></span>
                            <span class="hero-meta-pill"><i class="fas fa-clock"></i><span id="dashboardLocalTime">{{ now()->format('g:i A') }}</span></span>
                            <span class="hero-meta-pill"><i class="fas fa-user-tag"></i>{{ ucfirst($user->role) }}</span>
                        </div>
                    </div>
                    <div class="hero-status-card text-end">
                        ...
                        <p class="text-muted mb-0">{{ $reasonMessage }}</p>
                    </div>
                </div>
