    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body">
                    <p class="card-text text-muted small text-uppercase fw-bold mb-2">Reservations</p>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body">
                    <p class="card-text text-muted small text-uppercase fw-bold mb-2">Borrowings</p>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body">
                    <p class="card-text text-muted small text-uppercase fw-bold mb-2">Incidents</p>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-body">
                    <p class="card-text text-muted small text-uppercase fw-bold mb-2">Notifications</p>
