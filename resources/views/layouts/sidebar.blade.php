    ...
    <div class="sidebar-header">
        <div class="sidebar-branding">
            <div class="sidebar-logo" style="width:56px;height:56px;border-radius:50%;overflow:hidden;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.9);padding:6px;">
                {{-- Prefer the university seal if provided, otherwise fall back to existing ICTFE logos --}}
                @if(file_exists(public_path('images/logo-seal.png')))
                    <img src="{{ asset('images/logo-seal.png') }}" alt="University Seal" style="width:100%;height:100%;object-fit:contain;display:block;transition:transform .18s ease;" />
                @elseif(file_exists(public_path('images/logo-seal.svg')))
                    <img src="{{ asset('images/logo-seal.svg') }}" alt="University Seal" style="width:100%;height:100%;object-fit:contain;display:block;transition:transform .18s ease;" />
                @elseif(file_exists(public_path('images/ictfe-logo-circle.png')))
                    <img src="{{ asset('images/ictfe-logo-circle.png') }}" alt="ICTFE" style="width:100%;height:100%;object-fit:contain;display:block;transition:transform .18s ease;" />
                @else
                    <img src="{{ asset('images/ictfe-logo-circle.svg') }}" alt="ICTFE" style="width:100%;height:100%;object-fit:contain;display:block;transition:transform .18s ease;" />
                @endif
            </div>
...
<li class="sidebar-item">
        ...
        @if($role === 'student')
            ...
            <li class="sidebar-item">
                <a href="{{ route('bug-reports.create') }}" title="Report Bug" class="sidebar-link {{ Request::is('bug-reports/create') ? 'active' : '' }}">
            ...
            <li class="sidebar-item">
                <a href="{{ route('messages.index') }}" title="Messages" class="sidebar-link {{ Request::is('messages*') ? 'active' : '' }}">
        ...
        @if(Auth::user()->role === 'admin')
            ...
            <li class="sidebar-item">
                <a href="{{ route('bug-reports.index') }}" title="Bug Reports" class="sidebar-link {{ Request::is('bug-reports*') ? 'active' : '' }}">
                    <i class="fas fa-bug"></i>
